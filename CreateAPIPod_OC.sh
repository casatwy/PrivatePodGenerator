...
git clone https://github.com/casatwy/APITemplateProject_OC.git ${projectName}
...
mv ./${projectName}/APITemplateProject_OC ./${projectName}/${projectName}
mv ./${projectName}/${projectName}/APITemplateProject_OC ./${projectName}/${projectName}/${projectName}
mv ./${projectName}/APITemplateProject_OC.xcodeproj ./${projectName}/${projectName}.xcodeproj
...
sed -i "" "s%APITemplateProject_OC%${projectName}%g" "$readmeFilePath"

sed -i "" "s%__ProjectName__%${projectName}%g" "$gitignoreFilePath"
sed -i "" "s%APITemplateProject_OC%${projectName}%g" "$gitignoreFilePath"

sed -i "" "s%__ProjectName__%${projectName}%g" "$uploadFilePath"
sed -i "" "s%APITemplateProject_OC%${projectName}%g" "$uploadFilePath"
...
sed -i "" "s%APITemplateProject_OC%${projectName}%g" "$specFilePath"

sed -i "" "s%__ProjectName__%${projectName}%g" "$podfilePath"
sed -i "" "s%APITemplateProject_OC%${projectName}%g" "$podfilePath"
  
sed -i "" "s%APITemplateProject_OC%${projectName}%g" "./${projectName}/${projectName}.xcodeproj/project.pbxproj"
sed -i "" "s%__ServiceName__%${serviceName}%g" "./${projectName}/${projectName}.xcodeproj/project.pbxproj"

sed -i "" "s%APITemplateProject_OC%${projectName}%g" "./${projectName}/${projectName}.xcodeproj/project.xcworkspace/contents.xcworkspacedata"

sed -i "" "s%__ServiceName__%${serviceName}%g" $ViewControllerPath
sed -i "" "s%APITemplateProject_OC%${projectName}%g" $ViewControllerPath

sed -i "" "s%__ServiceName__%${serviceName}%g" $EventResponseViewControllerPath
sed -i "" "s%APITemplateProject_OC%${projectName}%g" $EventResponseViewControllerPath

sed -i "" "s%APITemplateProject_OC%${projectName}%g" $LifeCycleViewControllerPath

sed -i "" "s%APITemplateProject_OC%${projectName}%g" $UITableViewControllerPath

sed -i "" "s%__ServiceName__%${serviceName}%g" $ServiceFilePath
sed -i "" "s%APITemplateProject_OC%${projectName}%g" $ServiceFilePath
